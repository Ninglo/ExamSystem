...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(520, 370)
        self.setWindowFlags(QtCore.Qt.FramelessWindowHint|QtCore.Qt.Tool)
        self.setWindowOpacity(0.93)

        self.horizontalLayoutWidget = QtWidgets.QWidget(Dialog)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(320, 280, 250, 250))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(70, 100, 121, 238))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(380, 100, 141, 131))
        ...
        self.label.setGeometry(QtCore.QRect(260, 50, 120, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "专项练习"))
