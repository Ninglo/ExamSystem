    ...
    def check_(self):
        if self._currentQid < self.n1:
            ...
            if not bool_:
                ...
                messageBox3.setWindowTitle("提示")
                messageBox3.setText('答案错误，正确答案为：' + s)
                messageBox3.addButton(QPushButton("确定"), QMessageBox.YesRole)
                messageBox3.exec_()
                self.listWidget.item(self._currentQid).setBackground(QColor("#F16B6F"))
            else:
                #QMessageBox.information(self, '正确', '答案正确')
                messageBox4 = QMessageBox()
                messageBox4.setWindowTitle("提示")
                messageBox4.setText("答案正确！")
                messageBox4.addButton(QPushButton("确定"), QMessageBox.YesRole)
                messageBox4.exec_()
                self.listWidget.item(self._currentQid).setBackground(QColor("#AACD6E"))
        else:
            self.set_answer3()
            ...
            if not bool_:
                ...
                messageBox5.setWindowTitle("提示")
                messageBox5.setText('答案错误，正确答案为：' + s)
                messageBox5.addButton(QPushButton("确定"), QMessageBox.YesRole)
                messageBox5.exec_()
                self.listWidget.item(self._currentQid).setBackground(QColor("#F16B6F"))
            else:
                #QMessageBox.information(self, '正确', '答案正确')
                messageBox6 = QMessageBox()
                messageBox6.setWindowTitle("提示")
                messageBox6.setText("答案正确！")
                messageBox6.addButton(QPushButton("确定"), QMessageBox.YesRole)
                messageBox6.exec_()
                self.listWidget.item(self._currentQid).setBackground(QColor("#AACD6E"))
